...
(async function() {
  ...
  let ferdium = {
    ...
    onNotify(func) {
      console.warn(`Warning: Service ${spaceData.ferdiumId} is trying to call onNotify, but it is not yet implemented`);
    },

    handleDarkMode(func) {
      console.warn(`Warning: Service ${spaceData.ferdiumId} is trying to call handleDarkMode, but it is not yet implemented`);
    },

    clearStorageData(id, areas) {
      console.warn(`Warning: Service ${spaceData.ferdiumId} is trying to call clearStorageData, but it is not yet implemented`);
    },
    ...
    setAvatarImage(avatarUrl) {
      console.warn(`Warning: Service ${spaceData.ferdiumId} is trying to call setAvatarImage, but it is not yet implemented`);
    },

    initialize(func) {
      console.warn(`Warning: Service ${spaceData.ferdiumId} is trying to call initialize, but it is not yet implemented`);
    },

    ipcRenderer: {
      on: function() { // eslint-disable-line id-length
        console.warn(`Warning: Service ${spaceData.ferdiumId} is trying to call ipcRenderer.on, but it is not yet implemented`);
      }
    }
  };
